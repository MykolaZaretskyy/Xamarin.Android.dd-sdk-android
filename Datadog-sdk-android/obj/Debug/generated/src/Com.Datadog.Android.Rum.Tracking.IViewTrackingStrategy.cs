...
namespace Com.Datadog.Android.Rum.Tracking {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.datadog.android.rum.tracking']/interface[@name='ViewTrackingStrategy']"
	[Register ("com/datadog/android/rum/tracking/ViewTrackingStrategy", "", "Com.Datadog.Android.Rum.Tracking.IViewTrackingStrategyInvoker")]
	public partial interface IViewTrackingStrategy : global::Com.Datadog.Android.Rum.Tracking.ITrackingStrategy {
	}

	[global::Android.Runtime.Register ("com/datadog/android/rum/tracking/ViewTrackingStrategy", DoNotGenerateAcw=true)]
	internal partial class IViewTrackingStrategyInvoker : global::Java.Lang.Object, IViewTrackingStrategy {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/datadog/android/rum/tracking/ViewTrackingStrategy", typeof (IViewTrackingStrategyInvoker));
		...
		public static IViewTrackingStrategy GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IViewTrackingStrategy> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.datadog.android.rum.tracking.ViewTrackingStrategy'.");
			return handle;
		}
		...
		public IViewTrackingStrategyInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Datadog.Android.Rum.Tracking.IViewTrackingStrategy> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
